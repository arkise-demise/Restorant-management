...
func CreateFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := FindOne(ctx, bson.M{"menu_id": food.Menu_id}).Decode(&menu)
		defer cancel()
		if err != nil {
...
// FindOne is a helper function to find one document in the database
func FindOne(ctx context.Context, filter interface{}) *mongo.SingleResult {
	return foodCollection.FindOne(ctx, filter)
}
